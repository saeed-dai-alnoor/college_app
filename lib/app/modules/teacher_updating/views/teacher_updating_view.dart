...
class TeacherUpdatingView extends GetView<TeacherUpdatingController> {
  const TeacherUpdatingView({Key? key}) : super(key: key);
  @override
        ...
        body: Builder(
          builder: (context) => Obx(
            () => LoadingOverlay(
              ...
              child: Form(
                key: controller.updatingTeacherFormKey,
